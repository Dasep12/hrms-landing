...
Route::get('/pph', [App\Http\Controllers\HomeController::class, 'pph'])->name('pph.index');
Route::get('/overtime', [App\Http\Controllers\HomeController::class, 'overtime'])->name('overtime.index');
Route::get('/kompen-thr', [App\Http\Controllers\HomeController::class, 'kompen_thr'])->name('kompen_thr.index');
